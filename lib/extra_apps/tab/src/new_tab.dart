...
enum TabBarIndicatorSizeCustom {
...
class _IndicatorPainter extends CustomPainter {
  _IndicatorPainter({
    ...
    @required this.indicatorSizeCustom,
  ...
  final TabBarIndicatorSize indicatorSizeCustom;
  ...
  Rect indicatorRect(Size tabBarSize, int tabIndex) {
    ...
    if (indicatorSizeCustom == TabBarIndicatorSize.label) {
...
class _TabBarState extends State<TabBar> {
  ...
  void _initIndicatorPainter() {
    _indicatorPainter = _controller == null ? null : _IndicatorPainter(
      ...
      indicatorSizeCustom: widget.indicatorSize ?? TabBarTheme.of(context).indicatorSize,
      tabKeys: _tabKeys,
