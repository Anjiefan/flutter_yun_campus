...
didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [Bugly startWithAppId:@"773738a4fd"];
    //配置权限系统
...
//    [self initBeecloudPayment];
    [self initShare];
    [AVOSCloud setApplicationId:@"aveFaAUxq89hJCelmHX33pLU-gzGzoHsz" clientKey:@"SX8gmajxVuYL4MvfOCTvV5zR"];
    // 开启 LeanCloud 服务
//    [LCChatKit setAppId:@"aveFaAUxq89hJCelmHX33pLU-gzGzoHsz" appKey:@"SX8gmajxVuYL4MvfOCTvV5zR"];
//    
...
- (void) initShare{
    [ShareSDK registPlatforms:^(SSDKRegister *platformsRegister) {
         //QQ
        [platformsRegister setupQQWithAppId:@"101550785" appkey:@"04b6a0568d838310fbb49104ff654828"];
        //微信
        [platformsRegister setupWeChatWithAppId:@"wx58fbd34964417acc" appSecret:@"c2d771775f6435471a47007a315edcc1"];
        //新浪
        [platformsRegister setupSinaWeiboWithAppkey:@"3014452965" appSecret:@"920dd25723395fff5ac463993f18918e" redirectUrl:@"https://app.finerit.com/index.html"];
...
- (void) share:(NSString*)id{
    ...
    if (imageArray) {
        ...
        [shareParams SSDKSetupShareParamsByText:@"云智校，一个专属大学生的社交APP，一边娱乐一边赚钱，还有免费的代网课的自助系统哦～"
                                         images:imageArray
                                            url:[NSURL URLWithString:[@"https://hwapp.finerit.com/web/team_register/?father_id=" stringByAppendingString:id]]
                                          title:@"云智校APP"
...
- (void)initChannel{
    ...
    [shareMethodChannel setMethodCallHandler:^(FlutterMethodCall * _Nonnull call, FlutterResult  _Nonnull result) {
        ...
        if ([call.method isEqualToString:@"doShare"]) {
            ...
            NSLog(@"arguments = %@", ar);
            NSString* id=[ar objectAtIndex:0];
            [self share:id];
        }
...
//             NSArray *ar=[call arguments];
//            NSString *url=[ar objectAtIndex:0];
//            [[AlipaySDK defaultService] payOrder:url fromScheme:appScheme callback:^(NSDictionary *resultDic) {
...
//            NSDictionary *dataDic = [NSDictionary dictionaryWithObject:@"ok" forKey:@"billno"];
//
