...
class FeedBackWidgetComment extends StatefulWidget{
  CommentData obj;
  FeedBackWidgetComment({
    Key key,
    this.obj,
  }):super(key:key);
  @override
...
class FeedBackWidgetState extends State<FeedBackWidgetComment> {
...
//                    obj.status.text,
  ...
  void  handle_send_reportinfo()  {
    NetUtil.post(Api.REPORT_COMMENTS, (data) {
