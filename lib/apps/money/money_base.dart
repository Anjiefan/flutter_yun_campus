...
class MoneyAppState extends PageState<MoneyApp> {
  static const CHANNEL_PAYMENT_INVOKE =
      const MethodChannel("com.finerit.campus/payment/invoke");
  static const CHANNEL_PAYMENT_CONFIRM_ANDROID =
      const MethodChannel("com.finerit.campus/payment/confirm/android");
  var paymentResult = "";
  var sessionToken = "";
  ...
  void initState() {
    super.initState();
    CHANNEL_PAYMENT_CONFIRM_ANDROID.setMethodCallHandler((handler) {
      if (handler.method == "refreshMoney") {
        refresh_data();
      }
    });
  }
